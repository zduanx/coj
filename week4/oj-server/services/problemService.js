...
const getProblems = function(){
  console.log('>> problemService: In the problem service get problems')
...
const getProblem = function(numId){
  console.log('>> problemService: In the problem service get single problem');
  return new Promise((resolve, reject)=>{
...
const addProblem = function(newProblem){
  console.log('>> problemService: In the add problem service');
  return new Promise((resolve, reject) =>{
